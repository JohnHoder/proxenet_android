...
//#define xlog(t, _f, ...) __android_log_print(ANDROID_LOG_WARN, APPNAME, GEN_FMT _f, __FUNCTION__, __FILE__, __LINE__, __VA_ARGS__)
#define xlog(t, ...) __android_log_print(ANDROID_LOG_WARN, APPNAME, __VA_ARGS__)
